        ...
        public partial class RiceSpecies : PlantSpecies
        {
            public RiceSpecies() : base()
            {
               ...
               this.SpreadRate = 0.001f;  
                ...
                this.IdealTemperatureRange = new Range(0.67f,  0.7f);  
                this.IdealMoistureRange = new Range(0.5f,  0.54999995f);  
                this.IdealWaterRange = new Range(0, 0.1f);
                this.WaterExtremes = new Range(0, 0.2f);
                this.TemperatureExtremes = new Range(0.55f,  0.90000004f);  
                this.MoistureExtremes = new Range(0.4f,  0.7f);  
