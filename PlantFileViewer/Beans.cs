        ...
        public partial class BeansSpecies : PlantSpecies
        {
            public BeansSpecies() : base()
            {
               ...
               this.SpreadRate = 0.001f;  
                ...
                this.IdealTemperatureRange = new Range(0.45000002f,  0.55f);  
                this.IdealMoistureRange = new Range(0.4f,  0.44999993f);  
                this.IdealWaterRange = new Range(0, 0.1f);
                this.WaterExtremes = new Range(0, 0.2f);
                this.TemperatureExtremes = new Range(0.35000002f,  0.6f);  
                this.MoistureExtremes = new Range(0.35f,  0.75f);  
