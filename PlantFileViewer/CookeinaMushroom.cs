    ...
    public partial class CookeinaMushroom : PlantEntity
    {
        ...
        public partial class CookeinaMushroomSpecies : PlantSpecies
        {
            public CookeinaMushroomSpecies() : base()
            {
                ...
                this.DisplayName = Localizer.DoStr("Cookeina Mushroom");
                // Lifetime
               this.MaturityAgeDays = 1.4000001f;  
                // Generation
                this.Height = 1;
                // Food
                this.CalorieValue = 4;
               ...
               this.SpreadRate = 0.001f;  
                ...
                this.IdealTemperatureRange = new Range(0.45f,  0.59999996f);  
                this.IdealMoistureRange = new Range(0.65f,  0.7f);  
                this.IdealWaterRange = new Range(0, 0.1f);
                this.WaterExtremes = new Range(0, 0.2f);
                this.TemperatureExtremes = new Range(0.4f,  0.75f);  
